...
/**
 * Plugin Name:         Hide Titles - Remove Title from Posts and Pages, Disable All Titles
        ...
        <div class="hide_titles_aside hide_titles_common">
            ...
            <div class="author-card">
                ...
                <a class="link" href="https://wordpress.org/plugins/customized-login/" target="_blank">
                    <span class="dashicons dashicons-admin-plugins"></span> <b><?php _e( 'Customize Login Page', 'hide-titles' ) ?></b>
                </a>
            </div>
